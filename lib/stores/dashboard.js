 ...
 * Build-safe implementation with client-side checks
 */
const useDashboardStore = create(
  typeof window !== 'undefined' ? persist(
    (set, get) => ({
      ...
      cacheTimeout: 0, // No cache - always fetch fresh data
    ...
    // Minimal setters for server-side
    setInventories: () => {},
    setPublicInventories: () => {},
    ...
    setIsAdmin: () => {},
    isCacheValid: () => false,
    loadDashboardData: async () => ({ success: true, cached: true }),
    handleInventorySelect: () => {},
    handleSelectAllInventories: () => {},
    handlePublicInventorySelect: () => {},
    handleSelectAllPublicInventories: () => {},
    deleteSelectedInventories: async () => ({ success: false }),
    toggleVisibility: async () => ({ success: false }),
    deletePublicInventory: async () => ({ success: false }),
