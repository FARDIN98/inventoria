...
const useDashboardStore = create(
  typeof window !== 'undefined' ? persist(
    ...
    setIsAdmin: () => {},
    isCacheValid: () => false,
    isPublicCacheValid: () => false,
    loadInventories: async () => {},
    loadPublicInventories: async () => {},
    refreshInventories: async () => {},
    refreshPublicInventories: async () => {},
    deleteInventories: async () => {},
    deletePublicInventories: async () => {},
    toggleInventoryVisibility: async () => {},
    selectAllInventories: () => {},
    deselectAllInventories: () => {},
    selectAllPublicInventories: () => {},
    deselectAllPublicInventories: () => {},
    clearError: () => {},
    handleWindowResize: () => {},
    cleanup: () => {}
  })
