...
// Get user's inventories (admin can see all inventories)
export async function getUserInventoriesAction() {
  try {
    ...
    // If not admin, only show user's own inventories
    // If admin, show all inventories but prioritize public ones and user's own
    if (!isAdmin) {
