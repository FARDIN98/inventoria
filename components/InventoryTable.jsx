        ...
        <Table className="min-w-[700px] lg:min-w-full">
          <TableHeader>
            <TableRow className="bg-gradient-to-r from-blue-50/50 to-purple-50/50 dark:from-blue-950/30 dark:to-purple-950/30 border-b border-slate-200/50 dark:border-slate-700/50">
              <TableHead className="w-[300px] min-w-[250px] font-bold text-slate-700 dark:text-slate-200">{t('forms.title', 'Title')}</TableHead>
              <TableHead className="min-w-[200px] font-bold text-slate-700 dark:text-slate-200">{t('forms.description', 'Description')}</TableHead>
              <TableHead className="w-[200px] min-w-[150px] font-bold text-slate-700 dark:text-slate-200">{t('common.creator', 'Creator')}</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {data.map((inventory) => (
